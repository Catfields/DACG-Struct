...
def compute_structured_loss(
    ...
    """
    适配 MultiHeadClassifier 最新输出 dict 的 loss：
      outputs keys:
    ...
    (
        mention_labels, polarity_labels, prob_labels, sev_labels,
        modifier_labels, anatomy_labels,
        mask_pol, mask_prob, mask_sev, mask_mod, mask_anat
    ) = construct_labels(
